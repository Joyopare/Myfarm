...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-$&ml@(4q))*xdx!7b!-=m#%)gyavavuiz^ffvv4r^-5z-w5cop')
...
STRIPE_PUBLISHABLE_KEY = config('STRIPE_PUBLISHABLE_KEY', default='pk_test_your_stripe_publishable_key')
